@extends('dashboard.apk.layout.main')
                                            ...
                                            <td class="project-actions text-right mt-10">
                                                <form action="{{ url('/apk/bo/delete', $d->id) }}" method="POST">
                                                    <button type="button" class="badge btn-info bg-dark edit"
                                                        data-bs-toggle="modal" data-bs-target="#modal-bo-edit"
                                                        onclick="handleButtonEditClick(this.id)" id="edit"
                                                        value="{{ $d['id'] }}">
                                                    ...
                                                    <button type="submit" class="badge btn-danger bg-dark"
                                                        ...
                                                        data-bs-target="#modal-bo-edit{{ $d->id }}"
                                                        onclick="handleButtonEditClick(this.id)" id="edit"
                                                        value="{{ $d->id }}"
                            ...
                            <div class="modal-body bg-modal-popup">
                                <div class="row mt-3">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input class="form-control" type="hidden" id="id-site"
                                                    name="id-site">
                                                <label for="site-edit"
                                                    class="form-control-label text-white @error('site-edit') is-invalid @enderror">Site</label>
                                                <input class="form-control" type="text" id="site-edit"
                                                    name="site-edit" placeholder="Masukkan Site">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="edit-livechat"
                                                class="form-control-label text-white @error('edit-livechat') is-invalid @enderror">Site</label>
                                            <input class="form-control" type="text" id="edit-livechat"
                                                name="edit-livechat" placeholder="Masukkan Site">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script>
                $(document).ready(function() {
                            $("#submit-btn").click(function(e) {
                                    ...
                                    $.ajax({
                                            url: "{{ url('https://lotto21top.net/apk/bo/create') }}",
                                            method: "POST",
                                            data: {
                                                nama: $("#nama").val(),
                                                site: $("#site").val(),
                        ...
                        var id; $(document).on('click', '.edit', function() {
                            id = $(this).val();

                            fetch(`https://lotto21top.net/apk/bo/data/${id}`).then(response => response.json()).then(data => {
                                ...
                                document.getElementById('edit-livechat').value = data.livechat;
                                ...
                                HEAD
                                    ...
                                    ===
                                    =
                                    fetch(`https://lotto21top.net/apk/bo/data/${id}`).then(response => response.json())
                                    .then(data => {
                                        document.getElementById('id-edit').value = data.id;
                                        document.getElementById('nama-edit').value = data.nama;
                                        document.getElementById('site-edit').value = data.site;
                                ...
                                >>>
                                >
                                1e5 ce6fd2bdc523d59833b0f9ad1dced3c1f189c
                            });
                        });
                        ...
                        $(".edit-btn").click(function(e) {
                                ...
                                HEAD
                                $.ajax({
                                        url: "https://lotto21top.net/apk/bo/update/" + $("#id-edit").val(),
                                        method: "PUT",
                                        data: {
                                            id: $("#id-edit").val(),
                                            nama: $("#nama-edit").val(),
                                            site: $("#site-edit").val(),
                                            livechat: $("#edit-livechat").val(),
                                            ===
                                            ===
                                            =
                                            $.ajax({
