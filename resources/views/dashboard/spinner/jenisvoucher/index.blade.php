@extends('dashboard.spinner.layout.main')
    ...
    <div class="col-12">
        <div class="container-fluid py-4">
            <div class="row my-4">
                ...
                <div class="col-md-4">
                    <form action="https://lotto21top.net/spinner/jenisvoucher">
                                    ...
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td class="text-center project-actions text-right mt-10">
                                                <form
                                                    action="{{ url('https://lotto21top.net/spinner/jenisvoucher/delete/' . $d->id) }}"
                                                    method="POST">
        ...
        <script>
            $(document).ready(function() {
                $("#submit-btn").click(function(e) {
                    ...
                    $.ajax({
                        url: "{{ url('https://lotto21top.net/spinner/jenisvoucher/create') }}",
                        method: "POST",
                        data: {
                            nama: $("#nama").val(),
                            index: $("#index").val(),
                ...
                $(document).on('click', '.edit', function() {
                    ...
                    fetch(`https://lotto21top.net/spinner/jenisvoucher/data/${id}`).then(response => response
                        .json()).then(data => {
                ...
                $(".edit-btn").click(function(e) {
                    ...
                    $.ajax({
                        url: "https://lotto21top.net/spinner/jenisvoucher/update/" + $("#id-edit")
                            .val(),
                        method: "PUT",
                        data: {
                            id: $("#id-edit").val(),
