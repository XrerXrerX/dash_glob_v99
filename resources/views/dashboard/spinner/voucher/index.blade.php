    ...
    <div class="col-12">
        <div class="container-fluid py-4">
            <div class="row my-4">
                ...
                <div class="col-md-8">
                    ...
                    <form action="{{ route('spinner.voucher', ['id' => $id]) }}">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select class="form-select search_jenis_klaim" aria-label="Default select example"
                                    ...
                                    <option value="sudah_klaim"
                                        {{ $search_jenis_klaim == 'sudah_klaim' ? 'selected' : '' }}>Sudah Klaim</option>
                                    <option value="belum_klaim"
                                        {{ $search_jenis_klaim == 'belum_klaim' ? 'selected' : '' }}>Belum klaim</option>
                                </select>
                            </div>
                            <div class="col-md-3">
        ...
        <script>
            ...
            function updateVoucher(event, id) {
                ...
                $.ajax({
                    url: "https://lotto21top.net/spinner/voucher/update/" + id,
                    method: "PUT",
                    data: {
                        id: id,
                        username: userid,
            ...
            function exportArrayToExcel() {
                ...
                var newParameter = '/1';
                var newURL = currentURL + newParameter;
                console.log(newURL);
