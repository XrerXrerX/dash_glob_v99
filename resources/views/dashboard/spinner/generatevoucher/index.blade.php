                                    ...
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td class="text-center project-actions text-right mt-10">
                                                ...
                                                <form class="d-inline"
                                                    action="{{ url('https://lotto21top.net/spinner/generatevoucher/delete/' . $d->id) }}"
                                                    method="POST">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submit-btn").click(function(e) {
                    ...
                    $.ajax({
                        url: "{{ url('https://lotto21top.net/spinner/generatevoucher/create') }}",
                        method: "POST",
                        data: {
                ...
                $("#modal-voucher-tambah").on("hidden.bs.modal", function() {
                    $('#jenis_voucher').val('');
                    $('#tgl_exp').val(
                        '{{ date('
                                                                                    Y - m - d ') }}'
