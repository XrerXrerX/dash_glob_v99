...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-bo">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-bo">
                <div class="sec_edit">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->site }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-bo').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/apk/bo/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/bo/edit/' + parameterString);
            });
        });


        $(document).off('click', '#add-bo').on('click', '#add-bo', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/apk/bo/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/bo/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/apk/bo/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/apk/bo/delete');
        //     });
        // })



        $(document).on('click', '#delete-bo', function(event) {
            event.preventDefault();
            ...
            var url = "/apk/bo/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
    ...
    $(document).off('click', '#view').on('click', '#view', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/apk/bo/view/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/apk/bo/view/' + id);
        });
    });
    ...
    $(document).off('click', '#edit').on('click', '#edit', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/apk/bo/edit/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/apk/bo/edit/' + id);
        });
    });
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        Swal.fire({
                            ...
                            // Lakukan perubahan halaman atau tindakan lainnya setelah data berhasil dihapus
                            $('.aplay_code').load('/apk/bo', function() {
                                adjustElementSize();
                                localStorage.setItem('lastPage',
                                    '/apk/bo');
                            });
