...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-user">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-user">
                <div class="sec_edit">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click', '#add-user').on('click', '#add-user', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/user/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/user/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/user/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/user/delete');
        //     });
        // })
