        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->website_url }}</span></td>
                    <td class="show_img_tbl">
                        <span class="td_img_show gambar">Image</span>
                        <img class="table_img" src="{{ asset('storage/' . $d->image_url) }}" alt=""
                            style="display: none;">
                    </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-promosi').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/promosi/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/promosi/edit/' + parameterString);
            });
        });
        ...
        $(document).off('click', '#add-promosi').on('click', '#add-promosi', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/web/promosi/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/promosi/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/promosi/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/promosi/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-promosi', function(event) {
            ...
            var url = "/web/promosi/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/promosi/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/promosi/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/promosi/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/promosi/edit/' + id);
            });
        });
