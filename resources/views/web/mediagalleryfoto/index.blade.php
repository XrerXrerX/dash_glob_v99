...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-mediagalleryfoto">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-mediagalleryfoto">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-mediagalleryfoto">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->nama_foto }}</span></td>
                    <td class="show_img_tbl">
                        <span class="td_img_show gambar">{{ substr($d->foto_url, 0, 15) }}</span>
                        <img class="table_img" src="{{ asset('storage/' . $d->foto_url) }}" alt=""
                            style="display: none;">
                    </td>
                    <td><span class="name">{{ date('d-m-Y H:i:s', strtotime($d->tgl_foto)) }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-mediagalleryfoto').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/mediagalleryfoto/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryfoto/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-mediagalleryfoto').on('click', '#add-mediagalleryfoto', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/web/mediagalleryfoto/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryfoto/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/mediagalleryfoto/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/mediagalleryfoto/delete');
        //     });
        // })



        $(document).on('click', '#delete-mediagalleryfoto', function(event) {
            event.preventDefault();
            ...
            var url =
                "/web/mediagalleryfoto/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/mediagalleryfoto/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryfoto/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/mediagalleryfoto/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryfoto/edit/' + id);
            });
        });
