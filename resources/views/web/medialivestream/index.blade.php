...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-medialivestream">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-medialivestream">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->nama_live }}</span></td>

                    <td class="show_img_tbl">
                        <span class="td_img_show gambar">{{ $d->live_url }}</span>
                        <img class="table_img" src="https://i.ytimg.com/vi/{{ $d->live_url }}/maxresdefault.jpg"
                            alt="">
                    </td>
                    <td><span class="name">{{ $d->desk_live }}</span></td>
                    <td><span class="name">{{ date('d-m-Y H:i:s', strtotime($d->tgl_live)) }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-medialivestream').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/medialivestream/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medialivestream/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-medialivestream').on('click', '#add-medialivestream', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/web/medialivestream/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medialivestream/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/medialivestream/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/medialivestream/delete');
        //     });
        // })



        $(document).on('click', '#delete-medialivestream', function(event) {
            event.preventDefault();
            ...
            var url =
                "/web/medialivestream/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/medialivestream/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medialivestream/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/medialivestream/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medialivestream/edit/' + id);
            });
        });
