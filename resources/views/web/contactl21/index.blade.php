...
<div class="sec_table">
    <h2>{{ $title }}</h2>
    {{-- <a href="#" onclick="handleButtonAddClick(this.id)" id="add-contactl21">
    ...
    <a href="#" onclick="handleButtonEditClick(this.id)" id="update-contactl21">
        <div class="sec_edit">
    ...
    <table>
        <tbody>
            <tr class="head_table">
                ...
                <th>Social Media & Content</th>
                <th>Running Text Halaman Utama</th>
                <th>Link Rekomendasi</th>
                <th>Banner Promo Togel</th>
                <th>Banner Promo Slot</th>
                <th>Action</th>
    ...
    $(document).ready(function() {
        ...
        $('#myCheckbox, [id^="myCheckbox-"]').change(function() {
            ...
            if (isChecked) {
                ...
                $('#update-contactl21').css('display', 'flex');
            } else {
                $('.all_act_butt').hide();
                $('#update-contactl21').hide();
            }
        ...
        $('#update-contactl21').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/contactl21/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/contactl21/edit/' + parameterString);
            });
        });


        $(document).off('click', '#add-contactl21').on('click', '#add-contactl21', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/web/contactl21/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/contactl21/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/contactl21/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/contactl21/delete');
        //     });
        // })



        $(document).on('click', '#delete-contactl21', function(event) {
            event.preventDefault();
            ...
            var url = "/web/contactl21/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            Swal.fire({
                                ...
                                $('.aplay_code').load('/web/contactl21',
                                    function() {
                                        adjustElementSize();
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/contactl21/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/contactl21/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/contactl21/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/contactl21/edit/' + id);
            });
        });
