...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-medianews">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-medianews">
                <div class="sec_edit">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->nama_berita }}</span></td>
                    <td><span class="name">{{ $d->desk_berita }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function applySearchFilter() {
            let searchText = $('.searchData-name').val().trim().toLowerCase();

            $('.tabel-data tr').each(function(index) {
        ...
        $('#update-medianews').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/medianews/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medianews/edit/' + parameterString);
            });
        });


        $(document).off('click', '#add-medianews').on('click', '#add-medianews', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/web/medianews/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medianews/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/medianews/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/medianews/delete');
        //     });
        // })



        $(document).on('click', '#delete-medianews', function(event) {
            event.preventDefault();
            ...
            var url = "/web/medianews/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/medianews/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medianews/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/medianews/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/medianews/edit/' + id);
            });
        });
