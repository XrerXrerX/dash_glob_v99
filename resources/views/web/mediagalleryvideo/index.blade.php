...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-mediagalleryvideo">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-mediagalleryvideo">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-mediagalleryvideo">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->nama_video }}</span></td>
                    <td class="show_img_tbl">
                        <span class="td_img_show gambar">{{ substr($d->thumb_video, 0, 15) }}</span>
                        <img class="table_img" src="{{ asset('storage/' . $d->thumb_video) }}" alt=""
                            style="display: none;">
                    </td>
                    <td><span class="name">{{ date('d-m-Y H:i:s', strtotime($d->tgl_video)) }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-mediagalleryvideo').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/web/mediagalleryvideo/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryvideo/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-mediagalleryvideo').on('click', '#add-mediagalleryvideo', function(
            event) {
            event.preventDefault();
            $('.aplay_code').load('/web/mediagalleryvideo/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryvideo/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/web/mediagalleryvideo/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/web/mediagalleryvideo/delete');
        //     });
        // })



        $(document).on('click', '#delete-mediagalleryvideo', function(event) {
            event.preventDefault();
            ...
            var url =
                "/web/mediagalleryvideo/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/mediagalleryvideo/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryvideo/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/web/mediagalleryvideo/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/web/mediagalleryvideo/edit/' + id);
            });
        });
