...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update').click(function(event) {
            ...
            $('.aplay_code').load('/apk/contact/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/contact/edit/' + parameterString);
            });
        });
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            $('.aplay_code').empty();
            $('.aplay_code').load('/apk/contact/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/contact/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('namabo');
            $('.aplay_code').empty();
            $('.aplay_code').load('/apk/contact/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/contact/edit/' + id);
            });
        });
