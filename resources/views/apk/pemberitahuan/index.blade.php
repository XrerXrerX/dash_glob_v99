...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-pemberitahuan">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-pemberitahuan">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-pemberitahuan">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="content">{{ $d['content'] }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#pushall').click(function(event) {
            ...
            $('.aplay_code').load('/apk/pemberitahuan/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/pemberitahuan/edit/' + parameterString);
            });
        });
    });

    $(document).off('click', '#add-pemberitahuan').on('click', '#add-pemberitahuan', function(event) {
        event.preventDefault();
        $('.aplay_code').load('/apk/pemberitahuan/add', function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/apk/pemberitahuan/add');
        });
    });

    $('#update-pemberitahuan').off('click').click(function(event) {
        event.preventDefault();
    ...
    $(document).on('click', '#delete-pemberitahuan', function(event) {
        event.preventDefault();
        ...
        if (checkedValues.length === 0) {
            Swal.fire({
                icon: 'warning',
                title: 'Silahkan pilih pemberitahuan!',
                showConfirmButton: false,
                timer: 1500
            });
        ...
        var url =
            "/apk/pemberitahuan/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        Swal.fire({
                            ...
                            $('.aplay_code').load('/apk/pemberitahuan',
                                function() {
                                    adjustElementSize();
    ...
    $(document).off('click', '#view').on('click', '#view', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/apk/pemberitahuan/view/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/apk/pemberitahuan/view/' + id);
        });
    });
    ...
    $(document).off('click', '#edit').on('click', '#edit', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/apk/pemberitahuan/edit/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/apk/pemberitahuan/edit/' + id);
        });
    });
    ...
    $(document).on('click', '#delete', function(event) {
        ...
        var id = $(this).data('id');
        var url = "/apk/pemberitahuan/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
