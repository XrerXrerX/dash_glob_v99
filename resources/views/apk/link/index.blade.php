<div class="sec_table">
    <h2>{{ $title }}</h2>
    <a href="#" id="update" class="show_hide_crud">
        <div class="sec_edit">
    ...
    $(document).ready(function() {
        ...
        $('#update').click(function(event) {
            ...
            if (checkedValues.length === 0) {
                ...
                $('.aplay_code').load('/apk/link/edit/' + parameterString, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/apk/link/edit/' + parameterString);
                });
            }
        });
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            $('.aplay_code').empty();
            $('.aplay_code').load('/apk/link/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/link/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('namabo');
            $('.aplay_code').empty();
            $('.aplay_code').load('/apk/link/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/apk/link/edit/' + id);
            });
        });
    });
</script>
