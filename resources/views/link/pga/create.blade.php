<div class="sec_box hgi-100">
    <form action="" method="POST" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                <span class="sec_label">Link PGA</span>
                <input type="text" id="link_pga" name="link_pga">
            </div>
            <div class="list_form">
                <span class="sec_label">Switch Active</span>
                <div class="sec_togle">
                    <input type="checkbox" id="switch_active" name="switch_active" value="1">
