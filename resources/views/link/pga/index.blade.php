...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-pga">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-pga">
                <div class="sec_edit">
            ...
            @foreach ($data as $indexs => $dt)
                @foreach ($dt as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ $d['link_pga'] }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-pga').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/link/pga/{{ $bo }}/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/link/pga/{{ $bo }}/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-pga').on('click', '#add-pga', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/link/pga/{{ $bo }}/add/', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/link/pga/{{ $bo }}/add/');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/link/pga/{{ $bo }}/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/link/pga/{{ $bo }}/delete');
        //     });
        // })



        $(document).on('click', '#delete-pga', function(event) {
            event.preventDefault();
            ...
            var url =
                "/link/pga/{{ $bo }}/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/link/pga/{{ $bo }}/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/link/pga/{{ $bo }}/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/link/pga/{{ $bo }}/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/link/pga/{{ $bo }}/edit/' + id);
            });
        });
