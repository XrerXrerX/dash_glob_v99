...
<body>
    ...
    <div class="container part2">
            ...
            <div class="gamedemo">
                ...
                <div class="demotidakada">
                    <div class="boxdemotdk">
                        <img class="gambardemokosong" src="{{ URL::to('/') }}/front/img/game/slot/<?php echo $datagetdemo[0]['nama_file']; ?>"
                            alt="">
                ...
                <div class="grubtmbldemo">
                    <a href="rtp.php">
                        <div class="buttonrtpbb green">
                            <img class="btngmbr1" src="{{ URL::to('/') }}/front/img/slot-machine-l21.png"
                                alt="">
                    ...
                    <a href="promo.php">
                        <div class="buttonrtpbb green">
                            ...
                            <img class="btngmbr2" src="{{ URL::to('/') }}/front/img/kado-promosi.png" alt="">
            ...
            <div class="gameterkait <?php echo $datagetdemo[0]['provider']; ?>">
                        ...
                        <div class="modal-box">
                            ...
                            <div class="modal-body-rtp timer-container">
                                ...
                                <div class="row__tombol">
                                    ...
                                    <a href="/demo/<?= $pragmatic['id'] ?>"><button
                ...
                <div class="grubgameterkait jokergaming">
                    ...
                    <div class="game__item game__promo" data-id="<?= $joker['id'] ?>">
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $joker['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $habanero['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $microgaming['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $relaxgaming['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                ...
                <div class="grubgameterkait playngo">
                    ...
                    <div class="game__item game__promo" data-id="<?= $playngo['id'] ?>">
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $playngo['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $playtech['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $spadegaming['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                ...
                <div class="grubgameterkait pgsoft">
                    ...
                    <div class="game__item game__promo" data-id="<?= $pgsoft['id'] ?>">
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $pgsoft['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $toptrend['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                            ...
                            <div class="modal-body-rtp">
                                ...
                                <div class="row__tombol">
                                    <a href="<?= $kontak['webrekomen'] ?>" target="_blank"><button
                                            style="text-align: left; border-radius: 0 0 0 5px;"
                                            class="buttonred btndaftar">DAFTAR</button></a>
                                    <a href="/demo/<?= $redtiger['id'] ?>"><button
                                            style="text-align: right; border-radius: 0 0 5px 0;"
                                            class="buttongreen btnlogin">DEMO</button></a>
                                </div>
                            </div>
                ...
                <div class="grubgameterkait netent">
                    ...
                    <div class="game__item game__promo" data-id="<?= $netent['id'] ?>">
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $netent['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                ...
                <div class="grubgameterkait genesis">
                    ...
                    <div class="game__item game__promo" data-id="<?= $genesis['id'] ?>">
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $genesis['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                ...
                <div class="grubgameterkait bng">
                    ...
                    <div class="game__item game__promo" data-id="<?= $bng['id'] ?>">
                        ...
                        <div class="lihatpola">
                            <h5><?= $bng['nama_game'] ?></h5>
                            <button data-modal="modal-<?= $bng['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                ...
                <div class="grubgameterkait bigtime">
                    ...
                    <div class="game__item game__promo" data-id="<?= $bigtime['id'] ?>">
                        ...
                        <img class="gambargamenya"
                            src="{{ URL::to('/') }}/front/img/game/slot/bt/<?= $bigtime['nama_file'] ?>"
                            alt="<?= $bigtime['nama_game'] ?>">
                        <div class="game__provider">
                            <img src="{{ URL::to('/') }}/front/img/provider/<?= $bigtime['provider'] ?>-l21.png"
                                alt="">
                        </div>
                        <div class="game__hot">
                            <span>HOT!!!</span>
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $bigtime['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                    ...
                    <div class="modal-rtp" id="modal-<?= $bigtime['id'] ?>">
                        ...
                        <div class="modal-box">
                            ...
                            <div class="modal-header-rtp">
                                ...
                                <span>Tips Bermain Slot</span>
                                <img class="llprovider"
                                    src="{{ URL::to('/') }}/front/img/provider/<?= $bigtime['provider'] ?>-l21.png"
                                    alt="">
                            </div>
                            <div class="modal-body-rtp">
                                <div class="row__content__1 timer-container">
                ...
                <div class="grubgameterkait gmw">
                    ...
                    <div class="game__item game__promo" data-id="<?= $gmw['id'] ?>">
                        ...
                        <img class="gambargamenya"
                            src="{{ URL::to('/') }}/front/img/game/slot/gmw/<?= $gmw['nama_file'] ?>"
                            alt="<?= $gmw['nama_game'] ?>">
                        <div class="game__provider">
                            <img src="{{ URL::to('/') }}/front/img/provider/<?= $gmw['provider'] ?>-l21.png"
                                alt="">
                        </div>
                        <div class="game__hot">
                            <span>HOT!!!</span>
                        ...
                        <div class="lihatpola">
                            <h5><?= $gmw['nama_game'] ?></h5>
                            <button data-modal="modal-<?= $gmw['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                    ...
                    <div class="modal-rtp" id="modal-<?= $gmw['id'] ?>">
                        ...
                        <div class="modal-box">
                            ...
                            <div class="modal-header-rtp">
                                ...
                                <span>Tips Bermain Slot</span>
                                <img class="llprovider"
                                    src="{{ URL::to('/') }}/front/img/provider/<?= $gmw['provider'] ?>-l21.png"
                                    alt="">
                            </div>
                            <div class="modal-body-rtp">
                                <div class="row__content__1 timer-container">
                ...
                <div class="grubgameterkait idnslot">
                    ...
                    <div class="game__item game__promo" data-id="<?= $idnslot['id'] ?>">
                        ...
                        <img class="gambargamenya"
                            src="{{ URL::to('/') }}/front/img/game/slot/idn/<?= $idnslot['nama_file'] ?>"
                            alt="<?= $idnslot['nama_game'] ?>">
                        <div class="game__provider">
                            <img src="{{ URL::to('/') }}/front/img/provider/<?= $idnslot['provider'] ?>-l21.png"
                                alt="">
                        </div>
                        <div class="game__hot">
                            <span>HOT!!!</span>
                        ...
                        <div class="lihatpola">
                            ...
                            <button data-modal="modal-<?= $idnslot['id'] ?>"
                                class="buttonred modal-trigger-rtp">POLA</button>
                        </div>
                    </div>
                    ...
                    <div class="modal-rtp" id="modal-<?= $idnslot['id'] ?>">
                        ...
                        <div class="modal-box">
                            ...
                            <div class="modal-header-rtp">
                                ...
                                <span>Tips Bermain Slot</span>
                                <img class="llprovider"
                                    src="{{ URL::to('/') }}/front/img/provider/<?= $idnslot['provider'] ?>-l21.png"
                                    alt="">
                            </div>
                            <div class="modal-body-rtp">
                                <div class="row__content__1 timer-container">
        ...
        <script src="{{ URL::to('/') }}/front/js/hadiahaa.js"></script>
