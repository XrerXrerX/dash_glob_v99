...
<body>
    ...
    <div class="container part2">
        ...
        <div class="section jadwalpools">
            ...
            <div class="listbarubaru">
                <div class="listbutjadwal">
                    <a href="{{ URL::to('/') }}/listpools">Semua Jadwal</a>
                    <a href="{{ URL::to('/') }}/listpools">Lihat Prediksi</a>
                    <a href="{{ URL::to('/') }}#groupwebsite">Pasang Sekarang</a>
                </div>
            </div>
        </div>
        ...
        <div class="section containerrtp">
            ...
            <!-- <input type="hidden" id="selected_hari" name="selected_hari" value="<?php //echo $selected_hari;
            ?>"> -->
            <!-- <input type="hidden" id="selected-pasaran" name="selected_pasaran" data-selected-pasaran="<?php //echo $selected_pasaran;
            ?>"> -->
                        ...
                        <div id="card-head" class="card w-90 mb-3">
                            <div class="card-body" id="card-body">
                                <div class="container text-center">
                                            ...
                                            <div class="dropdown-center">
                                                ...
                                                <ul class="dropdown-menu" id="dropdown-menu-style">
                                                    <li><a id="dropdown-item" class="dropdown-item" href="#"
                                                            data-value="kol7" onclick="toggleColumn(7)">7 Col</a></li>
                                                    <li><a id="dropdown-item" class="dropdown-item" href="#"
                                        ...
                                        <div class="col">
                                            <div class="dropdown-center">
                                                <button id="btn-dropdown" class="btn buttonred dropdown-toggle"
                                                    type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <?= $selected_pasaran == '' ? 'HONGKONG' : $selected_pasaran ?>
                                                </button>
                                                <ul class="dropdown-menu" id="dropdown-menu-style">
                                                    <li>
                                                        <form method="POST">
                                    ...
                                    <hr>
                                    <h5 class="card-title">
                                        <?= 'TABEL PAITO : ' . ($selected_pasaran == '' ? 'HONGKONG' :
                                        $selected_pasaran) ?>
                                    </h5>
                                    <hr>
                                    <div id="color-palette" draggable="true">
                                        ...
                                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                            ...
                                            $selected_pasaran = isset($_GET['selected_pasaran']) ? $_GET['selected_pasaran'] : 'HONGKONG';
                                        }
                                        ...
                                        <div id="table-container" class="container">
                                            <table id="my-table" class="table table-bordered 7colom">
