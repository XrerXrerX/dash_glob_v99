                            ...
                            <tr>
                                ...
                                <td class="kolom_action">
                                    ...
                                    <div class="action_crud" id="2">
                                        ...
                                        <a href="#" class="triggermodal" data-target="show1">
                                            <div class="list_action">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-edit-circle"
                                                    viewBox="0 0 24 24" stroke-width="1.5" fill="none"
                            ...
                            <div class="conten_body_modal">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="list_form">
                                        ...
                                        <select id="" name="">
                                            <option class="sec_selected" value="arwanatoto" selected place>arwanatoto
                                            </option>
                                    ...
                                    <div class="sec_button_form">
                                        <button class="sec_botton btn_submit" type="submit" id=""
                                            name="">Submit</button>
