...
<div class="sec_list_sidemenu">
    ...
    <div class="nav_group">
        ...
        <div class="data_sidejsx">
            <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-google-analytics"
                    viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path
    ...
    <div class="nav_group">
        ...
        <div class="list_sidejsx">
            ...
            <div class="data_sidejsx">
                <a href="#" class="Menuleft" data-jenismenu="web" data-menuid="promosi" data-menu1="PROJECT"
                    data-menu2="Promosi">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tags"
                        viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                        stroke-linejoin="round">
            ...
            <div class="data_sidejsx">
                <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-mobile-search"
                        viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                        stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="sub_data_sidejsx">
                ...
                <a href="#"class="Menuleft" data-jenismenu="apk" data-menuid="contact" data-menu1="PROJECT"
                    data-menu2="APK" data-menu3="Contact APK">
                    <div class="list_subdata">
                        <div class="dotsub"></div>
                ...
                <a href="#" class="Menuleft" data-jenismenu="apk" data-menuid="setting" data-menu1="PROJECT"
                    data-menu2="APK" data-menu3="Setting APK">
                    <div class="list_subdata">
                        <div class="dotsub"></div>
            ...
            <div class="sub_data_sidejsx">
                <a href="#" class="Menuleft" data-jenismenu="paito" data-menuid="pasaran"
                ...
                <a href="#" class="Menuleft" data-jenismenu="paito" data-menuid="result" data-menu1="PROJECT"
                    data-menu2="APK" data-menu3="Result Paito">
                    <div class="list_subdata">
                        <div class="dotsub"></div>
            ...
            <div class="data_sidejsx">
                <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-carousel-horizontal"
                        viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                        stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="sub_data_sidejsx">
                <a href="#" id="#Pga_arwana"class="Menuleft" data-jenismenu="link"
                    data-menuid="pga/arwanatoto" data-menu1="PROJECT" data-menu2="Link PGA" data-menu3="Arwanatoto">
                    <div class="list_subdata">
                        <div class="dotsub"></div>
                        <span class="sub_title1">Arwanatoto</span>
                    </div>
            ...
            <div class="data_sidejsx">
                <a href="#" class="Menuleft" data-jenismenu="" data-menuid="bannermodal" data-menu1="PROJECT"
                    data-menu2="Banner Modal">
