...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-member">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-member">
                <div class="sec_edit">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-member').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/vip/member/{{ $bo }}/edit/' + parameterString,
                function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/vip/member/{{ $bo }}/edit/' +
                        parameterString);
                });
        });
        ...
        $(document).off('click', '#add-member').on('click', '#add-member', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/vip/member/{{ $bo }}/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/vip/member/{{ $bo }}/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/vip/member/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/vip/member/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-member', function(event) {
            ...
            var url =
                "/vip/member/{{ $bo }}/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
            console.log(url);
            Swal.fire({
    ...
    $(document).off('click', '#view').on('click', '#view', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/vip/member/{{ $bo }}/view/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/vip/member/{{ $bo }}/view/' + id);
        });
    });
    ...
    $(document).off('click', '#edit').on('click', '#edit', function(event) {
        ...
        var id = $(this).data('id');
        $('.aplay_code').empty();
        $('.aplay_code').load('/vip/member/{{ $bo }}/edit/' + id, function() {
            adjustElementSize();
            localStorage.setItem('lastPage', '/vip/member/{{ $bo }}/edit/' + id);
        });
    });
