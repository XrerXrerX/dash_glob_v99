    ...
    <form action="" method="POST" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                ...
                <textarea name="userid" id="userid" cols="30" rows="3"></textarea>
            </div>
            <div class="list_form">
                <span class="sec_label">Status</span>
                <div class="sec_togle">
                    <input type="checkbox" id="switch_active" name="switch_active" checked>
