...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-tablesyair">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-tablesyair">
                <div class="sec_edit">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->nm_pasar }}</span></td>
                    <td><span class="name">{{ $d->datepost }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-tablesyair').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/syair/tablesyair/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syair/tablesyair/edit/' + parameterString);
            });
        });


        $(document).off('click', '#add-tablesyair').on('click', '#add-tablesyair', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/syair/tablesyair/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syair/tablesyair/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/syair/tablesyair/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/syair/tablesyair/delete');
        //     });
        // })



        $(document).on('click', '#delete-tablesyair', function(event) {
            event.preventDefault();
            ...
            var url = "/syair/tablesyair/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            Swal.fire({
                                ...
                                $('.aplay_code').load('/syair/tablesyair',
                                    function() {
                                        adjustElementSize();
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/syair/tablesyair/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syair/tablesyair/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/syair/tablesyair/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syair/tablesyair/edit/' + id);
            });
        });
