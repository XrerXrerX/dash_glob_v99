...
<div class="sec_table">
    ...
    <div class="group_act_butt">
        <a href="#" onclick="handleButtonAddClick(this.id)" id="add-pasaran">
        ...
        <div class="all_act_butt">
            <a href="#" onclick="handleButtonEditClick(this.id)" id="update-pasaran">
                <div class="sec_edit">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->pasaran_nama }}</span></td>
                    <td><span class="name">{{ $d->pasaran_text }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-pasaran').off('click').click(function(event) {
        ...
        $(document).on('click', '#delete-pasaran', function(event) {
            event.preventDefault();
